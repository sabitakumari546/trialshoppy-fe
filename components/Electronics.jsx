  ...
  return (
    ...
    {/* <div className="flex overflow-x-auto max-w-full sm:flex-row sm:overflow-visible sm:max-w-auto md:max-w-3xl lg:max-w-4xl xl:max-w-5xl"> */}
      {cards.map((card, index) => (
        <div
          key={index}
          className="flex-shrink-0 w-13.37rem h-2.625 rem  rounded-lg mx-7 p-2"
        ...
        >
          ...
          <div className="mt-4">
            <p className="w-11.375rem h-2.5rem font-poppins font-bold text-center leading-[150%]">{card.title}</p>
